...
const ProjectsPage = () => {
    ...
    return (
        <>
            <Parallax bgImage='parallax2.jpeg' strength={800}>
                <div id='pageCont'>
                    ...
                    <div className='projectContainer'>
                        ...
                        <div className='project'>
                            <h1>Pokesearch</h1>
                            <p>
                                PokéSearch is a front-end application built
                                using HTML, CSS, Javascript, JQuery, and a
                                third-party API.
                            </p>
                            <motion.img
                                ...
                                alt='Pokesearch'
                                onClick={() =>
                                    setSelectedImg('pokesearch1.png')
                                }
                            />
                            <motion.img
                                whileHover={{ opacity: 1 }}
                                ...
                                alt='Pokesearch'
                                onClick={() =>
                                    setSelectedImg('pokesearch2.png')
                                }
                            />
                            <motion.img
                                whileHover={{ opacity: 1 }}
                                ...
                                alt='Pokesearch'
                                onClick={() =>
                                    setSelectedImg('pokesearch3.png')
                                }
                            />
                            <div id='projBtns'>
                                <a
                    ...
                    <div className='projectContainer'>
                        <div className='project'>
                            ...
                            <p>
                                Infinite Savannah is a "vaporwave" styled
                                skateshop which was built with a MERN stack
                    ...
                    <div className='projectContainer'>
                        ...
                        <div className='project'>
                            <h1>PERN To-Do</h1>
                            <p>
                                This full-stack application was built with a
                                PERN stack (PostgreSQL, Express.JS, React,
                                Node.JS).
                            </p>
                            <motion.img
                                whileHover={{ opacity: 1 }}
